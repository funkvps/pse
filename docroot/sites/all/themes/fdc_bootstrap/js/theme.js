...
jQuery(function()
{
	...
	if (x ) {
//		jQuery('.wrapper_privacy_notice .privacy_notice').hide();
	} else {
//		jQuery('.wrapper_privacy_notice .privacy_notice').show();
		jQuery('.wrapper_privacy_notice').show();
	}


	jQuery('.wrapper_privacy_notice .privacy_notice .notice_close').click(function() {

		createCookie('cookie', 'true', 0)
		var x = readCookie('cookie')
