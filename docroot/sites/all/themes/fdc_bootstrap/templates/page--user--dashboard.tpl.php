...
<div class="website_frame container">
	<div class="website_pad">
      ...
      <div class="row">
        ...
        <?php endif; ?>
        <section<?php print $content_column_class; ?>>
          <?php print render($page['content_second_chance']); ?>
        </section>
        <?php if (!empty($page['sidebar_second'])): ?>
          <aside class="col-sm-3" role="complementary">
            <?php print render($page['sidebar_second']); ?>
            <p class="small_link edit-my-preferences">
              <a href="/user/<?php print $user->uid; ?>/edit#interests">Edit my interests 11</a>
              &nbsp;&nbsp;&nbsp;<span class="help-button" data-toggle="tooltip" title="Courses, news and events on this page are filtered to match your interests" >
