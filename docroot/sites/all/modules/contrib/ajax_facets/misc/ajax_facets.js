(function ($) {
  ...
  Drupal.ajax_facets.bindResetLink = function (facetWrapperId, index, settings) {
    ...
    // BrightLemon, Brightlemon, brightlemon, hack, patch, Audrius, audrius 
    // Field name field-col-commerce:field-prod-location is escaped in facet_values array
    // I added check for this kind of complicated fields, second line of "if" statement
    if (facet_values[settings.facetapi.facets[index]['facetName']] != undefined 
        || facet_values[escape(settings.facetapi.facets[index]['facetName'])] != undefined ) {
  // END OF BrightLemon, Brightlemon, brightlemon, hack, patch, Audrius, audrius 
